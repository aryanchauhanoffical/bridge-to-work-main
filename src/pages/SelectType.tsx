...
const UserTypeCard = ({
  ...
  <div
    className={`glass-card rounded-xl p-6 cursor-pointer card-hover transition-all duration-300 hover:scale-[1.02] border-l-4 ${color} overflow-hidden relative flex flex-col h-full`}
    onClick={onClick}
  >
    ...
    <div className="flex items-center justify-center mt-6 text-primary text-sm font-medium border-t border-border/40 pt-4">
      <span>Continue</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  All opportunities and services are mapped to your location
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Same-day opportunities and emergency services
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Creating independence through meaningful work
                </p>
              </div>
            </div>
          </div>
