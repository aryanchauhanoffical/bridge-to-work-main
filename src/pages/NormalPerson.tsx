...
const NGOS_DATA: NGOData[] = [
  ...
  },
  {
    ...
    description:
      "Free or low-cost healthcare services for uninsured or low-income individuals.",
...
const NormalPerson = () => {
      ...
      if (activeFilterKeys.length > 0) {
        if (activeFilters["shelters"]) {
          ngoResults = ngoResults.filter((ngo) =>
            ngo.services.some((service) =>
              service.toLowerCase().includes("shelter")
            )
          );
        }
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <Header title="Seek Opportunities" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 h-[calc(100vh-240px)]">
          ...
          <div className="lg:col-span-2 overflow-auto pr-2">
            <Tabs
              ...
              className="w-full"
              onValueChange={(value) =>
                setActiveTab(value as "jobs" | "services")
              }
            >
              ...
              <TabsContent value="jobs" className="space-y-4 animate-fade-in">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-sm text-muted-foreground">
                    Showing opportunities near you
                  </span>
                </div>
