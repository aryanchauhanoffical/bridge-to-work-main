        ...
        <div className="w-full max-w-md mx-auto">
          <div className="text-center mb-8 animate-slide-in">
            <div className="inline-block p-3 mb-4 bg-gradient-to-br from-primary/10 to-blue-400/20 rounded-full">
              <Heart size={32} className="text-primary animate-pulse-subtle" />
            </div>
            ...
            <p className="text-muted-foreground text-balance text-lg">
              Encouraging people to assist meaningfully
            </p>
          </div>
            ...
            {[
              {
                title: "Find Work",
                description:
                  "Access nearby job opportunities that match your skills and availability. Get connected to meaningful employment with dignity.",
              ...
              },
              {
                title: "Get Help",
                description:
                  "Discover local resources, shelters, and support services to assist you. Connect with NGOs and government programs offering assistance.",
              ...
              },
              {
                ...
                description:
                  "Create sustainable pathways to independence through work, training, and community support. Your journey to self-reliance starts here.",
              ...
              >
                ...
                <h2 className="heading-2 mb-4 text-balance text-gray-800">
                  {section.title}
                </h2>
            ...
            {Array.from({ length: totalSections }).map((_, index) => (
              <button
                ...
                className={`h-2.5 rounded-full mx-1.5 transition-all ${
                  index === activeSection
                    ? "w-10 bg-gradient-to-r from-primary to-blue-500"
                    : "w-2.5 bg-muted"
                }`}
